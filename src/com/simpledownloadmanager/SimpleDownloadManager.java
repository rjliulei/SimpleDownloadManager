...
public class SimpleDownloadManager implements DownloadManager {
    ...
    */
    ...
    /** Constructor taking MAX THREAD POOL SIZE  Allows maximum of 5 threads.
    * Any number higher than five or less than one wont be respected.
    **/
    public SimpleDownloadManager(int threadPoolSize) {
